...
const volumeUpHandler = () => {
  ...
  console.log("increased volume by: ", increasedVolume);

  const percentage = Math.round(increasedVolume * 100);
...
const volumeDownHandler = () => {
  ...
  console.log("decreased volume by: ", decreasedVolume);

  const percentage = Math.round(decreasedVolume * 100);
  showToast(percentage + "%");
};
